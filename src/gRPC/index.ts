...
import { Connection, GetVersionedTransactionConfig, VersionedTransactionResponse } from "@solana/web3.js";
...
async function getTransaction() {
  const tx: VersionedTransactionResponse | null = await connection.getTransaction(
    "RJEAmCdgCbjzDgeFj2AoVq89Q6KDS6FnxMtxs6n6P4M4eHcavpLGNHK8trDkzyGUbc1ty61oJXTSCXQXNWttfhS",
    config
  );
